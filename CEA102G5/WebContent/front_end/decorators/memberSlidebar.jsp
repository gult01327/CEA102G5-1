                            ...
                            <div class="widget widget-product-categories">
                                ...
                                <ul class="product-categories">
                                    <div>
                                        ...
                                        <li><a href="<%=request.getContextPath()%>/front_end/les_favorites/listFavorites.jsp">課程收藏清單</a></li>                                        
                                        <li><a href="<%=request.getContextPath()%>/front_end/reservation/listReservation.jsp">個人課程清單</a></li>                                       
                                    </div>
                                </ul>
                            </div>
                            </c:if>
