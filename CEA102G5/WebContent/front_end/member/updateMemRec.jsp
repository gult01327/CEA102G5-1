...
<table id="table-1">
	<tr><td>
		 <h3>常用地址修改 - updateMemRec.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front_end/commodity/comindex.jsp"><img src="<%=request.getContextPath()%>/resource/images/food.jpg" width="100" height="100" border="0">回商城首頁</a></h4>
	</td></tr>
</table>
