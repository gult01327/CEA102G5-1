...
@WebServlet("/FindPicFromDBServlet")
public class FindPicFromDBServlet extends HttpServlet {  
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			InputStream in = getServletContext().getResourceAsStream("/resource/images/exception.jpg");
			byte[] b = new byte[in.available()];
			in.read(b);
			out.write(b);
			in.close();
